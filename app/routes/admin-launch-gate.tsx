    ...
    <div className="dashboard-shell">
      ...
      <main id="main-content" className="admin-main">
        ...
        >
          ...
          <p>
            Only passed checks count towards commercial launch readiness.
            Waivers remain visible but do not count as passed.
          </p>
        </section>
            ...
            <article className="application-card" key={check.key}>
              <div>
                ...
                {check.result?.evidenceReference && (
                  <p>Evidence: {check.result.evidenceReference}</p>
                )}
              </div>
