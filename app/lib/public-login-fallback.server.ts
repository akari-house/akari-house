...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;min-height:100vh;background:radial-gradient(circle at 82% 20%,rgba(240,79,135,.14),transparent 35%),#090B14}
    ...
    button{min-height:50px;border:0;border-radius:12px;background:#F04F87;color:#090B14;font-weight:800;font-size:1rem;cursor:pointer}.assist{display:flex;justify-content:space-between;gap:1rem;font-size:.9rem}.assist a,.footer a{color:#FFD33D}.footer{margin:1.25rem 0 0;color:#B7BAC5;font-size:.92rem}
