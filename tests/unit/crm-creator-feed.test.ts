...
describe("AKARI House public-safe CRM Creator feed", () => {
  it(
    "keeps the stable House identity while respecting profile privacy switches",
    () => {
      ...
      expect(creator.profileUrl).toBe(
        "https://akarihouse.com/profiles/alice",
      );
  ...
  it(
    "exposes location and languages only when the member opted to show them",
    () => {
  ...
  it(
    "enforces public Creator eligibility and excludes private contact data at the source",
    () => {
