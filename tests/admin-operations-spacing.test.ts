...
const styles = readFileSync("app/styles/admin-operations-spacing.css", "utf8");
...
describe("admin operations section rhythm", () => {
  it("keeps direct operations panels visually separated", () => {
    ...
    expect(styles).toContain(".admin-operations-main > section + section");
    expect(styles).toContain("margin-top: var(--app-section-gap)");
    expect(root).toContain('import "./styles/admin-operations-spacing.css";');
  });
});
