...
describe("profile visibility", () => {
  ...
  const connection = { ownerId: "owner", viewerId: "member", isConnected: true };
  const owner = { ownerId: "owner", viewerId: "owner", isConnected: false };

  it("allows public profiles for everyone", () => expect(canViewProfile("public", anonymous)).toBe(true));
